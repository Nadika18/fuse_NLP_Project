...
model_path = os.path.join(settings.BASE_DIR, "complaints/finalweb2vec.pkl")
with open(model_path, "rb") as model_file:
    clf = pickle.load(model_file)


word2vec_model_path = os.path.join(settings.BASE_DIR, "complaints/nepaliW2V_5Million.model")
...
encoder_path = os.path.join(settings.BASE_DIR, "complaints/labelencoder.pkl")   
