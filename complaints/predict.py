...
model_path=os.path.join(settings.BASE_DIR,'complaints/best_wav2vec_model')
processor_path=os.path.join(settings.BASE_DIR,'complaints/best_wav2vec_processor')
